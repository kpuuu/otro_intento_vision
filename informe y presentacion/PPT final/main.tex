...
\date{\scriptsize Visi\'on por computador, Universidad Diego Portales\\ \vspace{.10cm}Julio 9, 2015}
...
\begin{itemize}
\item No se conoce la informaci\'on de la iluminaci\'on no la intensidad de esta utilizada. Para calcular esto se utiliza la descomposici\'on de valores singulares.
...
Para poder realizar una fotometr\'ia est\'ereo no calibrada se utilizo, un c\'odigo base, el creador es Kai Wolf.
